        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              {!isNew ? (
                <ValidatedField name="id" required readOnly id="character-card-id" label="ID" validate={{ required: true }} />
              ) : null}
              <ValidatedField
                label="Name"
              ...
              />
              <ValidatedField label="Element" id="character-card-element" name="element" data-cy="element" type="select">
              ...
              <ValidatedField id="character-card-basic" name="basic" data-cy="basic" label="Basic" type="select" required>
                <option value="" key="0" />
                {basicATKS
              ...
              <ValidatedField id="character-card-skill" name="skill" data-cy="skill" label="Skill" type="select" required>
                <option value="" key="0" />
                {skillATKS
              ...
              <FormText>This field is required.</FormText>
              <ValidatedField id="character-card-ultimate" name="ultimate" data-cy="ultimate" label="Ultimate" type="select" required>
                <option value="" key="0" />
                {ultimateATKS
