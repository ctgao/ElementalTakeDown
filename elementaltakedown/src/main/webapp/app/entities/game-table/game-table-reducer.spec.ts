...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GAMETABLE_LIST actions', async () => {
    ...
    it('dispatches FETCH_GAMETABLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GAMETABLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GAMETABLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GAMETABLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GAMETABLE actions', async () => {
      const expectedActions = [
        {
