...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CARDPROFILE_LIST actions', async () => {
    ...
    it('dispatches FETCH_CARDPROFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CARDPROFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CARDPROFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CARDPROFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CARDPROFILE actions', async () => {
      const expectedActions = [
        {
