...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PLAYERPROFILE_LIST actions', async () => {
    ...
    it('dispatches FETCH_PLAYERPROFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PLAYERPROFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PLAYERPROFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PLAYERPROFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PLAYERPROFILE actions', async () => {
      const expectedActions = [
        {
