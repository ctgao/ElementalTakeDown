        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label="Name" id="user-profile-name" name="name" data-cy="name" type="text" />
              ...
              <ValidatedField label="Cards" id="user-profile-cards" data-cy="cards" type="select" multiple name="cards">
                <option value="" key="0" />
                {characterCards
