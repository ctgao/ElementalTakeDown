        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              {!isNew ? <ValidatedField name="id" required readOnly id="skill-atk-id" label="ID" validate={{ required: true }} /> : null}
              <ValidatedField label="Name" id="skill-atk-name" name="name" data-cy="name" type="text" />
              <ValidatedField label="Description" id="skill-atk-description" name="description" data-cy="description" type="text" />
              <ValidatedField id="skill-atk-damage" name="damage" data-cy="damage" label="Damage" type="select" required>
                <option value="" key="0" />
                {damages
