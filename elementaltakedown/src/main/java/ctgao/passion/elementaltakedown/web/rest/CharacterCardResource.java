...
public class CharacterCardResource {
    ...
    public ResponseEntity<CharacterCard> updateCharacterCard(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, characterCard.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<CharacterCard> partialUpdateCharacterCard(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, characterCard.getId().toString())
        );
    }
