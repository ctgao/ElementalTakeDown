...
public class BasicATKResource {
    ...
    public ResponseEntity<BasicATK> updateBasicATK(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, basicATK.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<BasicATK> partialUpdateBasicATK(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, basicATK.getId().toString())
        );
    }
