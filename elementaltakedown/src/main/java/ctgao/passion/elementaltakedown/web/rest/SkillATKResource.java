...
public class SkillATKResource {
    ...
    public ResponseEntity<SkillATK> updateSkillATK(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, skillATK.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<SkillATK> partialUpdateSkillATK(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, skillATK.getId().toString())
        );
    }
