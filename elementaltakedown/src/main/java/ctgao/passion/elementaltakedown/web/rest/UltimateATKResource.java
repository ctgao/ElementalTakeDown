...
public class UltimateATKResource {
    ...
    public ResponseEntity<UltimateATK> updateUltimateATK(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, ultimateATK.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<UltimateATK> partialUpdateUltimateATK(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, ultimateATK.getId().toString())
        );
    }
